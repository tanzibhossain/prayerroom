...
class ProfileController extends Controller
{
    public function profile() {
        return view('admin.profile_change');
    }
    ...
    public function profile_update(Request $request) {
        ...
        $obj = Admin::findOrFail(Auth::guard('admin')->user()->id);
    ...
    public function photo() {
        return view('admin.photo_change');
    }
    ...
    public function photo_update(Request $request) {
        ...
        unlink(public_path('uploads/user_photos/'.Auth::guard('admin')->user()->photo));
    ...
    public function banner() {
        return view('admin.banner_change');
    }
    ...
    public function banner_update(Request $request) {
        ...
        unlink(public_path('uploads/user_photos/'.Auth::guard('admin')->user()->banner));        
